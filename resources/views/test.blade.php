            ...
            <div class="sidebar-inner slimscroll">
                    ...
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                            ...
                            @if (in_array('All Employees',$names))
                                ...
                                <li class="submenu">
                                    ...
                                    <ul style="display: none;">
                                        ...
                                        @endif
                                        @if (in_array('Leave Setting',$names))
                                            <li><a href="leaves-employee">Leaves (Employee)</a></li>
                                        @endif
                                        @if (in_array('Leave Employee',$names))
                                ...
                                <li class="submenu">
                                    ...
                                    <ul style="display: none;">
                                        ...
                                        @if (in_array('Service Users',$names))
                                            <li><a href="routes">Service Users)</a></li>
                                        @endif
                                    </ul>
                                </li>    
                            @endif
                            ...
                            @endif
                            @if (in_array('Employee Salary',$names))
                                <li class="submenu">
