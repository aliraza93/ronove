...
Vue.component('add-schedule', require('./components/Employee/Schedule/AddSchedule.vue').default);
Vue.component('view-schedule', require('./components/Employee/Schedule/ViewSchedule.vue').default);
Vue.component('update-schedule', require('./components/Employee/Schedule/UpdateSchedule.vue').default);
