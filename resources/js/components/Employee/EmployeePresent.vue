<template>
    ...
    <div id="employee-present-modal" class="modal custom-modal fade" role="dialog">
                    ...
                    <div class="modal-body">
                        ...
                        <form>
                            ...
                            <div class="submit-section">
                                <button type="button" @click="addPresentEducationDetails()" class="btn btn-primary submit-btn">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
...
export default {
  ...
  methods: {
    ...
    addPresentEducationDetails() {
        axios
        .post(base_url + "employee-present-details/"+this.id, this.employee)

        .then(response => {
          $("#employee-present-modal").modal("hide");
